...
import { User, Mail, Lock, Loader2, UserPlus, Shield, BarChart3, Package } from 'lucide-react';
            ...
            <div className="hidden lg:flex lg:w-[48%] bg-slate-900 items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-white px-14 py-16 max-w-lg animate-fade-in">
                    ...
                    <p className="text-slate-400 text-base leading-relaxed mb-12">
                        Get started in minutes. Create an account to access real-time inventory, analytics, and secure role-based access.
                    </p>
                ...
                <div className="w-full max-w-[420px] animate-scale-in">
                    ...
                    <div className="bg-white rounded-2xl shadow-[0_4px_24px_-4px_rgba(15,23,42,0.08),0_8px_16px_-4px_rgba(15,23,42,0.04)] border border-slate-200/80 p-8 sm:p-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="mt-1.5 text-sm text-slate-500">Enter your details to get started</p>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 pointer-events-none" strokeWidth={1.75} />
                                        <input
                                            id="name"
                                            type="text"
                                            required
                            ...
                            >
                                {loading ? (
                                    ...
                                    <>
                                        Create account
                                        <UserPlus className="w-4 h-4 opacity-80" strokeWidth={2} />
                                    </>
                                )}
                            </button>
                        </form>
