...
const PurchaseOrders = () => {
    ...
    return (
        <div className="min-h-screen bg-white animate-fade-in">
            {/* Header - same structure as Inventory / Products */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-sm text-indigo-600 mt-0.5">Manage and track your purchase orders.</p>
                        </div>
                        {canCreate && (
                            <button
                            ...
                            >
                                <Plus size={20} strokeWidth={2} /> Create order
                            </button>
                        )}
                    </div>
                </div>
