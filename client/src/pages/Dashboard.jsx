...
import { DollarSign, ShoppingCart, Package, AlertTriangle, Layers, Plus, ArrowLeftRight } from 'lucide-react';
        ...
        <div className="space-y-8 animate-fade-in p-2">
            <header className="mb-0">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    {/* Tab Switcher - Warehouse Admin Only */}
            ...
            {/* Tab: Overview */}
            {(user?.role !== 'WAREHOUSE_ADMIN' || activeTab === 'overview') && (
